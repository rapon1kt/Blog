import { Avatar, Typography, Box, Stack, Divider, Button } from "@mui/material";
					...
					{currentUser._id === userId && !user.avatar_url && (
						<>
							<Typography
								...
								align="center"
							>
								Ops! Aparentemente você ainda não terminou seu registro,
								atualize suas informações abaixo para explorar os artigos e
								vídeos!
							</Typography>
							<EditUserProfile userId={currentUser._id} />
						</>
